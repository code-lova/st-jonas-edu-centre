<div class="offcanvas bg-blue  text-light offcanvas-start" tabindex="-1" id="mobileMenu"
    ...
    <div class="d-grid pt-1 gap-2">
        <a class="link-underline small-menu-active-blue rounded-1 small-menu-blue p-2 text-light fs-7 link-underline-opacity-0"
        href="/dashboard/">
