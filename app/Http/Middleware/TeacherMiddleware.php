        ...
        if(Auth::check()){
            if(Auth::user()->role == 'teacher'){
               ...
               if (Auth::user()->role === 'admin') {
                return redirect('/admin/dashboard')->with('error', 'Access Denied: You are not a teacher');
            } elseif (Auth::user()->role === 'student') {
                return redirect('/student/dashboard')->with('error', 'Access Denied: You are not a teacher');
            }
